        ...
        <div class="container">
            ...
            <div class="card" style="margin-top : 5%; border : 1.5px solid; border-color : #3bbcdb;">
                ...
                <div class="card-body">
                    ...
                    <button style="float: left; font-weight : 600; border : 1.5px solid; border-color :#3bbcdb; background-color : white; color : #3bbcdb; margin-top : 40px" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDeluxe">
                        Lihat Fasilitas >>
                    </button>
            ...
            <div class="card"
                ...
                <div class="card-body" style="text-align: -webkit-right;">
                    ...
                    <button style="float: left; font-weight : 600; border : 1.5px solid; border-color :#3bbcdb; background-color : white; color : #3bbcdb; margin-top : 40px" type="button" class="btn btn-primary" data-toggle="modal" data-target="#contohModalScroll">
                        Lihat Fasilitas >>
                    </button>
